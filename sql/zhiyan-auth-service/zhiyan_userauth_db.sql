...
CREATE TABLE user_roles (
    ...
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE COMMENT '用户删除时级联删除关联记录',
    FOREIGN KEY (role_id) REFERENCES roles(id) ON DELETE CASCADE COMMENT '角色删除时级联删除关联记录',
...
CREATE TABLE role_permissions (
    ...
    FOREIGN KEY (role_id) REFERENCES roles(id) ON DELETE CASCADE COMMENT '角色删除时级联删除关联记录',
    FOREIGN KEY (permission_id) REFERENCES permissions(id) ON DELETE CASCADE COMMENT '权限删除时级联删除关联记录'
) COMMENT '角色与权限的多对多关联表（角色继承权限）';